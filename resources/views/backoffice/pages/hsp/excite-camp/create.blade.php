...
@section('breadcrumb')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create ExCITE Camp Location</li>
        </ol>
    </section>
@endsection
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Create ExCITE Camp Location</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ route('backoffice.hsp.excite-camp.location.create.post') }}" method="post" role="form">
                        {{ csrf_field() }}
                        <div class="box-body">
